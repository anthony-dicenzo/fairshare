...
// The fixed Supabase connection string (as a fallback)
...
// Get database connection string, using SUPABASE_CONNECTION as fallback
const connectionString = process.env.DATABASE_URL || SUPABASE_CONNECTION;
